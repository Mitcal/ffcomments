<?php
$pagetitle='Wrong Fuel East Riding of Yorkshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel East Riding of Yorkshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel East Riding of Yorkshire: If you've put wrong fuel in your car in East Riding of Yorkshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel East Riding of Yorkshire, wrong fuel in car East Riding of Yorkshire';
$main_h1="East Riding of Yorkshire";
$main_h2="Mobile Units On Call across East Riding of Yorkshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout East Riding of Yorkshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel East Riding of Yorkshire" width="100%">
					<h3>Wrong Fuel East Riding of Yorkshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of East Riding of Yorkshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="East Riding of Yorkshire Petrol in a Diesel Car" width="100%">
				<h3>East Riding of Yorkshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in East Riding of Yorkshire:</p>
		<table class="table table-sm">
			<tr><td>Bridlington</td><td>Hornsea</td><td>Woodmansey</td></tr>
			<tr><td>Beverley</td><td>Pocklington</td><td>Molescroft</td></tr>
			<tr><td>Goole</td><td>Willerbyy</td><td>Market Weighton</td></tr>
			<tr><td>Hessle</td><td>Brough</td><td>Withernsea</td></tr>
			<tr><td>Driffield</td><td>Hedon</td><td>Howden</td></tr>
		</table>
		</div>
