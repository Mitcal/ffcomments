<?php
$pagetitle='Wrong Fuel Shropshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Shropshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Shropshire: If you've put wrong fuel in your car in Shropshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Shropshire, wrong fuel in car Shropshire';
$main_h1="Shropshire";
$main_h2="Mobile Units On Call across Shropshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Shropshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Shropshire" width="100%">
					<h3>Wrong Fuel Shropshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Shropshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Shropshire Petrol in a Diesel Car" width="100%">
				<h3>Shropshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Shropshire:</p>
		<table class="table table-sm">
			<tr><td>Telford</td><td>Bridgnorth</td><td>Whitchurch</td></tr>
			<tr><td>Shrewsbury</td><td>Market Drayton</td><td>Oakengates</td></tr>
			<tr><td>Wellington</td><td>Newport</td><td>Shifnal</td></tr>
			<tr><td>Madeley</td><td>Dawley</td><td>Muxton</td></tr>
			<tr><td>Oswestry</td><td>Ludlow</td><td>Wem</td></tr>
		</table>
		</div>
