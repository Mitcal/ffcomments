<?php
$pagetitle='Wrong Fuel Somerset - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Somerset: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Somerset: If you've put wrong fuel in your car in Somerset, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Somerset, wrong fuel in car Somerset';
$main_h1="Somerset";
$main_h2="Mobile Units On Call across Somerset Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Somerset. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Somerset" width="100%">
					<h3>Wrong Fuel Somerset</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Somerset. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Somerset Petrol in a Diesel Car" width="100%">
				<h3>Somerset Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Somerset:</p>
		<table class="table table-sm">
			<tr><td>Bath</td><td>Portishead</td><td>Keynsham</td></tr>
			<tr><td>Weston-super-Mare</td><td>Burnham-on-Sea</td><td>Chard</td></tr>
			<tr><td>Taunton</td><td>Highbridge</td><td>Street</td></tr>
			<tr><td>Yeovil</td><td>Clevedon</td><td>Midsomer Norton</td></tr>
			<tr><td>Bridgwater</td><td>Nailsea</td><td>Minehead</td></tr>
			<tr><td>Frome</td><td></td><td></td></tr>
		</table>
		</div>
