<?php
$pagetitle='Wrong Fuel Lincolnshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Lincolnshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Lincolnshire: If you've put wrong fuel in your car in Lincolnshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Lincolnshire, wrong fuel in car Lincolnshire';
$main_h1="Lincolnshire";
$main_h2="Mobile Units On Call across Lincolnshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Lincolnshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Lincolnshire" width="100%">
					<h3>Wrong Fuel Lincolnshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Lincolnshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Lincolnshire Petrol in a Diesel Car" width="100%">
				<h3>Lincolnshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Lincolnshire:</p>
		<table class="table table-sm">
			<tr><td>Lincoln</td><td>Cleethorpes</td><td>Sleaford</td></tr>
			<tr><td>Grimsby</td><td>Spalding</td><td>Louth</td></tr>
			<tr><td>Scunthorpe</td><td>Skegness</td><td>North Hykeham</td></tr>
			<tr><td>Grantham</td><td>Gainsborough</td><td>Bourne</td></tr>
			<tr><td>Boston</td><td>Stamford</td><td>Market Deeping</td></tr>
		</table>
		</div>
