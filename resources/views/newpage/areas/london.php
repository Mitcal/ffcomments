<?php
$pagetitle='Wrong Fuel London - Fuel Fixer Lrd';
$metadesc="Wrong Fuel London: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel London: If you've put wrong fuel in your car in London, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel London, wrong fuel in car London';
$main_h1="London";
$main_h2="Mobile Units On Call across London Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout London. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel London" width="100%">
					<h3>Wrong Fuel London</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of London. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="London Petrol in a Diesel Car" width="100%">
				<h3>London Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in London:</p>
		<table class="table table-sm">
			<tr><td>City of London</td><td>Haringey</td><td>Lewisham</td></tr>
			<tr><td>Camden</td><td>Islington</td><td>Newham</td></tr>
			<tr><td>Hackney</td><td>Kensington</td><td>Southwark</td></tr>
			<tr><td>Hammersmith</td><td>Chelsea</td><td>Wandsworth</td></tr>
			<tr><td>Fulham</td><td>Lambeth</td><td>City of Westminster</td></tr>
		</table>
		</div>
