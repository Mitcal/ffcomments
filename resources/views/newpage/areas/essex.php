<?php
$pagetitle='Wrong Fuel Essex - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Essex: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Essex: If you've put wrong fuel in your car in Essex, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Essex, wrong fuel in car Essex';
$main_h1="Essex";
$main_h2="Mobile Units On Call across Essex Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Essex. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Essex" width="100%">
					<h3>Wrong Fuel Essex</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Essex. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Essex Petrol in a Diesel Car" width="100%">
				<h3>Essex Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Essex:</p>
		<table class="table table-sm">
			<tr><td>Southend-on-Sea</td><td>Thundersley</td><td>Canvey Island</td></tr>
			<tr><td>Colchester</td><td>Harlow</td><td>Billericay</td></tr>
			<tr><td>Chelmsford</td><td>Grays</td><td>Wickford</td></tr>
			<tr><td>Basildon</td><td>Brentwood</td><td>Loughton</td></tr>
			<tr><td>Rayleigh</td><td>Clacton-on-Sea</td><td>Stanford-le-Hope</td></tr>
			<tr><td>South Benfleet</td><td>South Benfleet</td><td></td></tr>
		</table>
		</div>
