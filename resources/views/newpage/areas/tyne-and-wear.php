<?php
$pagetitle='Wrong Fuel Tyne and Wear - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Tyne and Wear: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Tyne and Wear: If you've put wrong fuel in your car in Tyne and Wear, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Tyne and Wear, wrong fuel in car Tyne and Wear';
$main_h1="Tyne and Wear";
$main_h2="Mobile Units On Call across Tyne and Wear Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Tyne and Wear. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Tyne and Wear" width="100%">
					<h3>Wrong Fuel Tyne and Wear</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Tyne and Wear. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Tyne and Wear Petrol in a Diesel Car" width="100%">
				<h3>Tyne and Wear Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Tyne and Wear:</p>
		<table class="table table-sm">
			<tr><td>Newcastle upon Tyne</td><td>Washington</td><td>Hebburn</td></tr>
			<tr><td>Sunderland</td><td>Wallsend</td><td>Whickham</td></tr>
			<tr><td>Gateshead</td><td>Jarrow</td><td>Ryton</td></tr>
			<tr><td>South Shields</td><td>Longbenton</td><td>Blaydon</td></tr>
			<tr><td>Tynemouth</td><td>Whitley Bay</td><td>Houghton-le-Spring</td></tr>
		</table>
		</div>
