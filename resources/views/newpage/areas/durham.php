<?php
$pagetitle='Wrong Fuel Durham - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Durham: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Durham: If you've put wrong fuel in your car in Durham, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Durham, wrong fuel in car Durham';
$main_h1="Durham";
$main_h2="Mobile Units On Call across Durham Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Durham. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Durham" width="100%">
					<h3>Wrong Fuel Durham</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Durham. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Durham Petrol in a Diesel Car" width="100%">
				<h3>Durham Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Durham:</p>
		<table class="table table-sm">
			<tr><td>Darlington</td><td>Peterlee</td><td>Seaham</td></tr>
			<tr><td>Hartlepool</td><td>Newton Aycliffe</td><td>Stanley</td></tr>
			<tr><td>Stockton-on-Tees</td><td>Bishop Auckland</td><td>Spennymore</td></tr>
			<tr><td>Durham</td><td>Consett</td><td>Crook</td></tr>
			<tr><td>Billingham</td><td>Chester-le-Street</td><td>Shildon</td></tr>
