<?php
$pagetitle='Wrong Fuel Northumberland - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Northumberland: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Northumberland: If you've put wrong fuel in your car in Northumberland, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Northumberland, wrong fuel in car Northumberland';
$main_h1="Northumberland";
$main_h2="Mobile Units On Call across Northumberland Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Northumberland. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Northumberland" width="100%">
					<h3>Wrong Fuel Northumberland</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Northumberland. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Northumberland Petrol in a Diesel Car" width="100%">
				<h3>Northumberland Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Northumberland:</p>
		<table class="table table-sm">
			<tr><td>Blyth</td><td>Berwick-upon-Tweed</td><td>Alnwick</td></tr>
			<tr><td>Cramlinton</td><td>Hexham</td><td>Seaton Delaval</td></tr>
			<tr><td>Ashington</td><td>Prudhoe</td><td>Newbiggin-by-the-Sea</td></tr>
			<tr><td>Bedlington</td><td>Ponteland</td><td>Amble</td></tr>
			<tr><td>Morpeth</td><td>Stakeford</td><td></td></tr>
		</table>
		</div>
