<?php
$pagetitle='Wrong Fuel South Yorkshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel South Yorkshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel South Yorkshire: If you've put wrong fuel in your car in South Yorkshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel South Yorkshire, wrong fuel in car South Yorkshire';
$main_h1="South Yorkshire";
$main_h2="Mobile Units On Call across South Yorkshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout South Yorkshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel South Yorkshire" width="100%">
					<h3>Wrong Fuel South Yorkshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of South Yorkshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="South Yorkshire Petrol in a Diesel Car" width="100%">
				<h3>South Yorkshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in South Yorkshire:</p>
		<table class="table table-sm">
			<tr><td>Sheffield</td><td>Bentley</td><td>Rawmarsh</td></tr>
			<tr><td>Doncaster</td><td>Wombwell</td><td>Hoyland</td></tr>
			<tr><td>Rotherham</td><td>Chapeltown</td><td>Maltby</td></tr>
			<tr><td>Barnsley</td><td>Dinnington</td><td>Conisbrough</td></tr>
			<tr><td>Wath-upon-Dearne</td><td>Adwick-le-Street</td><td>Mexborough</td></tr>
		</table>
		</div>
