<?php
$pagetitle='Wrong Fuel East Sussex - Fuel Fixer Lrd';
$metadesc="Wrong Fuel East Sussex: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel East Sussex: If you've put wrong fuel in your car in East Sussex, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel East Sussex, wrong fuel in car East Sussex';
$main_h1="East Sussex";
$main_h2="Mobile Units On Call across East Sussex Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout East Sussex. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel East Sussex" width="100%">
					<h3>Wrong Fuel East Sussex</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of East Sussex. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="East Sussex Petrol in a Diesel Car" width="100%">
				<h3>East Sussex Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in East Sussex:</p>
		<table class="table table-sm">
			<tr><td>Brighton and Hove</td><td>Crowborough</td><td>Uckfield</td></tr>
			<tr><td>Eastbourne</td><td>Hailsham</td><td>Newhaven</td></tr>
			<tr><td>Hastings</td><td>Potslade-by-Sea</td><td>Saltdean</td></tr>
			<tr><td>Bexhill-on-Sea</td><td>Peacehaven</td><td>Polegate</td></tr>
			<tr><td>Seaford</td><td>Lewes</td><td>Heathfield</td></tr>
		</table>
		</div>
