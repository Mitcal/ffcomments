<?php
$pagetitle='Wrong Fuel Warwickshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Warwickshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Warwickshire: If you've put wrong fuel in your car in Warwickshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Warwickshire, wrong fuel in car Warwickshire';
$main_h1="Warwickshire";
$main_h2="Mobile Units On Call across Warwickshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Warwickshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Warwickshire" width="100%">
					<h3>Wrong Fuel Warwickshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Warwickshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Warwickshire Petrol in a Diesel Car" width="100%">
				<h3>Warwickshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Warwickshire:</p>
		<table class="table table-sm">
			<tr><td>Nuneaton</td><td>Stratford-upon-Avon</td><td>Kingsbury</td></tr>
			<tr><td>Rugby</td><td>Kenilworth</td><td>Alcester</td></tr>
			<tr><td>Royal Leamington Spa</td><td>Atherstone</td><td>Southam</td></tr>
			<tr><td>Warwick</td><td>Polesworth</td><td>Coleshill</td></tr>
			<tr><td>Bedworth</td><td>Whitnash</td><td>Sudley</td></tr>
		</table>
		</div>
