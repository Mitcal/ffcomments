<?php
$pagetitle='Wrong Fuel Hertfordshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Hertfordshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Hertfordshire: If you've put wrong fuel in your car in Hertfordshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Hertfordshire, wrong fuel in car Hertfordshire';
$main_h1="Hertfordshire";
$main_h2="Mobile Units On Call across Hertfordshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Hertfordshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Hertfordshire" width="100%">
					<h3>Wrong Fuel Hertfordshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Hertfordshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Hertfordshire Petrol in a Diesel Car" width="100%">
				<h3>Hertfordshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Hertfordshire:</p>
		<table class="table table-sm">
			<tr><td>Watford</td><td>Cheshunt</td><td>Hitchin</td></tr>
			<tr><td>Hemel Hemstead</td><td>Hoddesdon</td><td>Letchworth</td></tr>
			<tr><td>Stevenage</td><td>Bishop’s Stortford</td><td>Harpenden</td></tr>
			<tr><td>St Albans</td><td>Hatfield</td><td>Hertford</td></tr>
			<tr><td>Welwyn Garden City</td><td>Borehamwood</td><td>Bushey</td></tr>
		</table>
		</div>
