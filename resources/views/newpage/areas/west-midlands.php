<?php
$pagetitle='Wrong Fuel West Midlands - Fuel Fixer Lrd';
$metadesc="Wrong Fuel West Midlands: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel West Midlands: If you've put wrong fuel in your car in West Midlands, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel West Midlands, wrong fuel in car West Midlands';
$main_h1="West Midlands";
$main_h2="Mobile Units On Call across West Midlands Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout West Midlands. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel West Midlands" width="100%">
					<h3>Wrong Fuel West Midlands</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of West Midlands. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="West Midlands Petrol in a Diesel Car" width="100%">
				<h3>West Midlands Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in West Midlands:</p>
		<table class="table table-sm">
			<tr><td>Birmingham</td><td>Dudley</td><td>Willenhall</td></tr>
			<tr><td>Coventry</td><td>West Bromwich</td><td>Kingswinford</td></tr>
			<tr><td>Wolverhampton</td><td>Walsall</td><td>Smethwick</td></tr>
			<tr><td>Solihull</td><td>Stourbridge</td><td>Bloxwich</td></tr>
			<tr><td>Sutton Coldfield</td><td>Halesowen</td><td>Tipton</td></tr>
		</table>
		</div>
