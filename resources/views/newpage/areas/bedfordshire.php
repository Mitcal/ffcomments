<?php
$pagetitle='Wrong Fuel Bedfordshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Bedfordshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Bedfordshire: If you've put wrong fuel in your car in Bedfordshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel bedfordshire, wrong fuel in car bedfordshire';
$main_h1="Bedfordshire";
$main_h2="Mobile Units On Call across Bedfordshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Bedfordshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Bedfordshire" width="100%">
					<h3>Wrong Fuel Bedfordshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Bedfordshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Bedfordshire Petrol in a Diesel Car" width="100%">
				<h3>Bedfordshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Bedfordshire:</p>
		<table class="table table-sm">
			<tr><td>Luton</td><td>Houghton Regis</td><td>Stotfold</td></tr>
			<tr><td>Bedford</td><td>Biggleswade</td><td>Shefford</td></tr>
			<tr><td>Dunstable</td><td>Flitwick</td><td>Cranfield</td></tr>
			<tr><td>Leighton Buzzard</td><td>Sandy</td><td>Barton-le-Clay</td></tr>
			<tr><td>Kempston</td><td>Ampthill</td><td></td></tr>
		</table>
		</div>
