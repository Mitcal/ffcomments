<?php
$pagetitle='Wrong Fuel Staffordshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Staffordshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Staffordshire: If you've put wrong fuel in your car in Staffordshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Staffordshire, wrong fuel in car Staffordshire';
$main_h1="Staffordshire";
$main_h2="Mobile Units On Call across Staffordshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Staffordshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Staffordshire" width="100%">
					<h3>Wrong Fuel Staffordshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Staffordshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Staffordshire Petrol in a Diesel Car" width="100%">
				<h3>Staffordshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Staffordshire:</p>
		<table class="table table-sm">
			<tr><td>Stoke-on-Trent</td><td>Lichfield</td><td>Leek</td></tr>
			<tr><td>Tamworth</td><td>Cannock</td><td>Biddulph</td></tr>
			<tr><td>Newcastle-under-Lyme</td><td>Burntwood</td><td>Hednesford</td></tr>
			<tr><td>Burton-upon-Trent</td><td>Kidsgrove</td><td>Stone</td></tr>
			<tr><td>Stafford</td><td>Rugeley</td><td>Wombourne</td></tr>
		</table>
		</div>
