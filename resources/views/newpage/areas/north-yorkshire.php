<?php
$pagetitle='Wrong Fuel North Yorkshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel North Yorkshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel North Yorkshire: If you've put wrong fuel in your car in North Yorkshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel North Yorkshire, wrong fuel in car North Yorkshire';
$main_h1="North Yorkshire";
$main_h2="Mobile Units On Call across North Yorkshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout North Yorkshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel North Yorkshire" width="100%">
					<h3>Wrong Fuel North Yorkshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of North Yorkshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="North Yorkshire Petrol in a Diesel Car" width="100%">
				<h3>North Yorkshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in North Yorkshire:</p>
		<table class="table table-sm">
			<tr><td>York</td><td>Thornaby-on-Tees</td><td>Northallerton</td></tr>
			<tr><td>Middlesbrough</td><td>Ingleby Barwick</td><td>Ripon</td></tr>
			<tr><td>Harrogate</td><td>Yarm-on-Tees</td><td>Knaresborough</td></tr>
			<tr><td>Scarborough</td><td>Selby</td><td>Skipton</td></tr>
			<tr><td>Redcar</td><td>Guisborough</td><td>Whitby</td></tr>
		</table>
		</div>
