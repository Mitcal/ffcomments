<?php
$pagetitle='Wrong Fuel Gloucestershire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Gloucestershire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Gloucestershire: If you've put wrong fuel in your car in Gloucestershire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Gloucestershire, wrong fuel in car Gloucestershire';
$main_h1="Gloucestershire";
$main_h2="Mobile Units On Call across Gloucestershire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Gloucestershire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Gloucestershire" width="100%">
					<h3>Wrong Fuel Gloucestershire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Gloucestershire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Gloucestershire Petrol in a Diesel Car" width="100%">
				<h3>Gloucestershire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Gloucestershire:</p>
		<table class="table table-sm">
			<tr><td>Gloucester</td><td>Tewkesbury</td><td>Innsworth</td></tr>
			<tr><td>Cheltenham</td><td>Cirencester</td><td>Bishop Cleeve</td></tr>
			<tr><td>Kingswood</td><td>Frampton Cotterell</td><td>Downend</td></tr>
			<tr><td>Filton</td><td>Winterbourne</td><td>Thornbury</td></tr>
			<tr><td>Stroud</td><td>Dursley</td><td>Cinderford</td></tr>
			<tr><td>Yate</td><td></td><td></td></tr>
		</table>
		</div>
