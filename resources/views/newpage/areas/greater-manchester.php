<?php
$pagetitle='Wrong Fuel Greater Manchester - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Greater Manchester: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Greater Manchester: If you've put wrong fuel in your car in Greater Manchester, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Greater Manchester, wrong fuel in car Greater Manchester';
$main_h1="Greater Manchester";
$main_h2="Mobile Units On Call across Greater Manchester Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		...
		<p>We cover all these areas in Greater Manchester:</p>
		<table class="table table-sm">
			<tr><td>Manchester</td><td>Salford</td><td>Atherton</td></tr>
			<tr><td>Bolton</td><td>Wigan</td><td>Ashton-under-Lyne</td></tr>
			<tr><td>Sale</td><td>Oldham</td><td>Middleton</td></tr>
			<tr><td>Rochdale</td><td>Bury</td><td>Urmston</td></tr>
			<tr><td>Stockport</td><td>Leigh</td><td>Eccles</td></tr>
		</table>
		</div>
