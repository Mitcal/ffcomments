<?php
$pagetitle='Wrong Fuel Hampshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Hampshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Hampshire: If you've put wrong fuel in your car in Hampshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Hampshire, wrong fuel in car Hampshire';
$main_h1="Hampshire";
$main_h2="Mobile Units On Call across Hampshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Hampshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Hampshire" width="100%">
					<h3>Wrong Fuel Hampshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Hampshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Hampshire Petrol in a Diesel Car" width="100%">
				<h3>Hampshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Hampshire:</p>
		<table class="table table-sm">
			<tr><td>Southampton</td><td>Farnborough</td><td>Havant</td></tr>
			<tr><td>Portsmouth</td><td>Andover</td><td>Fareham</td></tr>
			<tr><td>Basingstoke</td><td>Aldershot</td><td>Fleet</td></tr>
			<tr><td>Eastleigh</td><td>Horndean</td><td>Totton</td></tr>
			<tr><td>Gosport</td><td>Winchester</td><td></td></tr>
		</table>
		</div>
