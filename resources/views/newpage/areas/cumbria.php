<?php
$pagetitle='Wrong Fuel Cumbria - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Cumbria: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Cumbria: If you've put wrong fuel in your car in Cumbria, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Cumbria, wrong fuel in car Cumbria';
$main_h1="Cumbria";
$main_h2="Mobile Units On Call across Cumbria Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Cumbria. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Cumbria" width="100%">
					<h3>Wrong Fuel Cumbria</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Cumbria. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Cumbria Petrol in a Diesel Car" width="100%">
				<h3>Cumbria Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Cumbria:</p>
		<table class="table table-sm">
			<tr><td>Carlisle</td><td>Penrith</td><td>Bowness-on-Windermere</td></tr>
			<tr><td>Barrow-in-Furness</td><td>Dalton-in-Furness</td><td>Windermere</td></tr>
			<tr><td>Kendal</td><td>Newton</td><td>Cockermouth</td></tr>
			<tr><td>Workington</td><td>Maryport</td><td>Egremont</td></tr>
			<tr><td>Whitehaven</td><td>Ulverston</td><td></td></tr>
