<?php
$pagetitle='Wrong Fuel Northamptonshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Northamptonshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Northamptonshire: If you've put wrong fuel in your car in Northamptonshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Northamptonshire, wrong fuel in car Northamptonshire';
$main_h1="Northamptonshire";
$main_h2="Mobile Units On Call across Northamptonshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Northamptonshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Northamptonshire" width="100%">
					<h3>Wrong Fuel Northamptonshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Northamptonshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Northamptonshire Petrol in a Diesel Car" width="100%">
				<h3>Northamptonshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Northamptonshire:</p>
		<table class="table table-sm">
			<tr><td>Northampton</td><td>Daventry</td><td>Irthingborough</td></tr>
			<tr><td>Kettering</td><td>Brackley</td><td>Higham Ferrers</td></tr>
			<tr><td>Corby</td><td>Desborough</td><td>Rothwell</td></tr>
			<tr><td>Wellingborough</td><td>Towcester</td><td>Burton Latimer</td></tr>
			<tr><td>Rushden</td><td>Raunds</td><td>Thrapston</td></tr>
		</table>
		</div>
