<?php
$pagetitle='Wrong Fuel Cheshire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Cheshire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Cheshire: If you've put wrong fuel in your car in Cheshire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Cheshire, wrong fuel in car Cheshire';
$main_h1="Cheshire";
$main_h2="Mobile Units On Call across Cheshire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Cheshire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Cheshire" width="100%">
					<h3>Wrong Fuel Cheshire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Cheshire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Cheshire Petrol in a Diesel Car" width="100%">
				<h3>Cheshire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Cheshire:</p>
		<table class="table table-sm">
			<tr><td>Warrington</td><td>Macclesfield</td><td>Nantwich</td></tr>
			<tr><td>Chester</td><td>Northwich</td><td>Poynton</td></tr>
			<tr><td>Crewe</td><td>Wilmslow</td><td>Neston</td></tr>
			<tr><td>Runcorn</td><td>Winslow</td><td>Middlewich</td></tr>
			<tr><td>Widnes</td><td>Congleton</td><td>Alsager</td></tr>
			<tr><td>Ellesmere port</td><td>Sandbach</td><td>Knutsford</td></tr>
