<?php
$pagetitle='Wrong Fuel Kent - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Kent: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Kent: If you've put wrong fuel in your car in Kent, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Kent, wrong fuel in car Kent';
$main_h1="Kent";
$main_h2="Mobile Units On Call across Kent Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Kent. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Kent" width="100%">
					<h3>Wrong Fuel Kent</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Kent. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Kent Petrol in a Diesel Car" width="100%">
				<h3>Kent Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Kent:</p>
		<table class="table table-sm">
			<tr><td>Maidstone</td><td>Margate</td><td>Dover</td></tr>
			<tr><td>Gillingham</td><td>Royal Tunbridge Wells</td><td>Ramsgate</td></tr>
			<tr><td>Dartford</td><td>Gravesend</td><td>Tonbridge</td></tr>
			<tr><td>Chatham</td><td>Canterbury</td><td>Herne Bay</td></tr>
			<tr><td>Ashford</td><td>Folkestone</td><td>Whitstable</td></tr>
			<tr><td>Rochester</td><td>Sittingbourne</td><td>Deal</td></tr>
			<tr><td>Sevenoaks</td><td></td><td></td></tr>
		</table>
		</div>
