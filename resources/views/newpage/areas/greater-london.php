<?php
$pagetitle='Wrong Fuel Greater London - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Greater London: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Greater London: If you've put wrong fuel in your car in Greater London, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Greater London, wrong fuel in car Greater London';
$main_h1="Greater London";
$main_h2="Mobile Units On Call across Greater London Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Greater London. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Greater London" width="100%">
					<h3>Wrong Fuel Greater London</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Greater London. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Greater London Petrol in a Diesel Car" width="100%">
				<h3>Greater London Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Greater London:</p>
		<table class="table table-sm">
			<tr><td>Barking</td><td>Ealing</td><td>Kingston upon Thames</td></tr>
			<tr><td>Dagenham</td><td>Enfield</td><td>Merton</td></tr>
			<tr><td>Barnet</td><td>Greenwich</td><td>Redbridge</td></tr>
			<tr><td>Bexley</td><td>Harrow</td><td>Richmond upon Thames</td></tr>
			<tr><td>Brent</td><td>Havering</td><td>Sutton</td></tr>
			<tr><td>Bromley</td><td>Hillingdon</td><td>Waltham Forest</td></tr>
			<tr><td>Croydon</td><td>Hounslow</td><td></td></tr>
		</table>
		</div>
