<?php
$pagetitle='Wrong Fuel Lancashire - Fuel Fixer Lrd';
$metadesc="Wrong Fuel Lancashire: If you have put wrong fuel in your car call for immediate assistance. We can get you can safely get back on your journey.";
$splashdesc="Wrong Fuel Lancashire: If you've put wrong fuel in your car in Lancashire, call for immediate assistance - don't try to drive on. Your car will be fixed at the roadside, so you can safely get back on your journey.";
$pagekw='wrong fuel Lancashire, wrong fuel in car Lancashire';
$main_h1="Lancashire";
$main_h2="Mobile Units On Call across Lancashire Now";
...
<div class="row">
	...
	<section class="ff-content-section">
		<div class="container">
			<p>We have fuel drain technicians based throughout Lancashire. Our average arrival time is 46 minutes. Fuel removal and re-setting usually takes another half hour. Get yourself and any passengers to a safe place while you wait, and let us know your location. Read on for more information about the effects of wrong fuel, and for our FAQ.</p>			
		</div><!-- .container --> 
		<div class="row">
			<div class="col-md-6">
				<div class="container">
					<img src="{{ asset('uploads/wrong_fuel.jpg') }}" alt="Wrong Fuel Lancashire" width="100%">
					<h3>Wrong Fuel Lancashire</h3>
					<p>If you have put the wrong fuel into your vehicle, Fuel Fixer are able to provide you with a 24 hour a day, 7 days-a-week mobile fuel drain service, with the ability to offer our assistance to the entirety of Lancashire. We will come out to your car, drain the contaminated fuel from your tank, flush the entire system and get you up on the road in no time.</p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="container">
				<img src="{{ asset('uploads/Petrol-in-a-diesel-car.jpg') }}" alt="Lancashire Petrol in a Diesel Car" width="100%">
				<h3>Lancashire Petrol in a Diesel Car</h3>
		...
		<p>We cover all these areas in Lancashire:</p>
		<table class="table table-sm">
			<tr><td>Blackpool</td><td>Lancaster</td><td>Accrington</td></tr>
			<tr><td>Blackburn</td><td>Lytham St Anne’s</td><td>Skelmersdale</td></tr>
			<tr><td>Preston</td><td>Leyland</td><td>Morecambe</td></tr>
			<tr><td>Burnley</td><td>Chorley</td><td>Nelson</td></tr>
			<tr><td>Bamber Bridge</td><td>Fulwood</td><td>Darwen</td></tr>
		</table>
		</div>
